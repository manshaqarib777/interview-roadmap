...
export const metadata: Metadata = {
  ...
  description: `All ${TOTAL_LESSONS} JavaScript, TypeScript, React and Next.js concepts as one dependency map: nodes are concepts, edges are prerequisites, laid out left to right in the order you should learn them.`,
  keywords: [
